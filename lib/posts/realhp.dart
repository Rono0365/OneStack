...
class rhp extends StatefulWidget {
  rhp(
      {Key? key,
      required this.token,
  ...
  @override
  State<rhp> createState() => _rhpState();
}

class _rhpState extends State<rhp> {
  var sky2 = [];
  var pic_url = [];
  var information = [];
                    ...
                    Container(
                      ...
                      child: RefreshIndicator(
                        ...
                        child: SingleChildScrollView(
                          child: Column(
                            children: [
                              Text(widget.clubpage.where((nt) =>nt["whoiswho"] 
                              != null ).map((e) => e["whoiswho"]).toSet().toList().toString()),
